        ...
        <div className=" grid  grid-flow-row md:grid-cols-3 gap-2 lg:grid-cols-4   ">
          {anime22.map((item) => (
            <div key={item.id} className="py-4">
              <article className="w-30 gap-4 px-2 hover:bg-[url(https://demonslayer-hinokami.sega.com/img/purchase/digital-standard.jpg)] bg-cover bg-no-repeat bg-center   rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:shadow-sm mx-auto relative">
