  ...
  return (
    <>
      <div className="lg:px-16 sm:px-4 flex flex-col sm:flex-row      sm:py-8  justify-center gap-8">
        <article className="w-80 px-2 hover:bg-[url(https://demonslayer-hinokami.sega.com/img/purchase/digital-standard.jpg)] bg-cover bg-no-repeat bg-center   rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:shadow-sm mx-auto">
